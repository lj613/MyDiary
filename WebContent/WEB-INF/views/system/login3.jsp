...
<link href="../h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" /> <!-- 修改路径 -->
<link href="../h-ui/css/H-ui.login.css" rel="stylesheet" type="text/css" /><!-- 修改路径 -->
<link href="../h-ui/lib/icheck/icheck.css" rel="stylesheet" type="text/css" /><!-- 修改路径 -->
<link href="../h-ui/lib/Hui-iconfont/1.0.1/iconfont.css" rel="stylesheet" type="text/css" /><!-- 修改路径 -->
...
<script type="text/javascript" src="../easyui/jquery.min.js"></script> <!-- 修改路径 添加    ../ -->
<script type="text/javascript" src="../h-ui/js/H-ui.js"></script> <!-- 修改路径 添加    ../ -->
<script type="text/javascript" src="../h-ui/lib/icheck/jquery.icheck.min.js"></script> <!-- 修改路径 添加    ../ -->

<script type="text/javascript" src="../easyui/jquery.easyui.min.js"></script>  <!-- 修改路径 添加    ../ -->
...
<div class="footer">Copyright &nbsp; SWU @ liujia </div>
