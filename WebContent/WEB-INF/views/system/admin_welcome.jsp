			...
			<div class="statistics">
				...
				<div class="panel panel-default chart-box">
					<div class="panel-heading">
						<h3 class="panel-title">用户性别比例</h3>
					</div>
	...
	<script type="text/javascript">
	 $(function () {
	  ...
	  //格式化时间函数
	    ...
	    // 性别比例饼状图
	    var myChart = echarts.init(document.getElementById('sex-chart'));
	    var femaleNum = ${femaleNum};
	    var maleNum = ${maleNum}
	 /*    alert("女生数量："+ femaleNum); */
	    option = {
	         title : {
	            text: '用户性别比例',       //大标题
	            // subtext: '纯属虚构',                //类似于副标题
