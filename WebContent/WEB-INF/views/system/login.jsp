...
<!-- 
	...
	<script type="text/javascript" src="../static/js/jquery.icheck.min.js"></script>  <!-- 验证 -->
    ...
    <style>
        ...
        .login-wrap .input-box input:focus~label,
        .login-wrap .input-box input:valid~label {
            top: -18px;
            left: 0;
            color: #03a9f4;
            font-size: 12px;
        ...
        .vcode-box .input-box input:focus~label,
        .vcode-box .input-box input:valid~label {
            top: -18px;
            left: 16px;
            color: #03a9f4;
            font-size: 12px;
        ...
        <div class="login-wrap">
            ...
            <form id="form">
                ...
                <div class="vcode-box row">
                    ...
                    <div class="col-md-6">
                        <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=5&w=150&h=40">
                    </div>
                </div>
                ...
                <div class="radio-box">
                    <label class="radio-inline">
                        <input type="radio" name="type" id="radio2" value="2" checked> 用户
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="type" id="radio1" value="1"> 管理员
                    </label>
                </div>
                <!-- 按钮部分 -->
